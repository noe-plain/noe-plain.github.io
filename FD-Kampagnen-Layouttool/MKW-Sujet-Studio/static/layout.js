...
(function(root){
 ...
 function textLayout(b,measure,activeKey){const safe=safeRect(b),visible=keys.filter(k=>k!=='copyright'&&((b.elements[k].visible&&b.elements[k].text)||k===activeKey)),gap=8*b.w/1080;
